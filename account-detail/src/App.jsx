  ...
  const renderItems = () => {
    ...
    if (activeTab === 'cart') {
      return cartItems.map((item) => (
        <div className="loan-card" key={item.id}>
          <div className="loan-card-left">
            ...
            <div className="loan-info">
              ...
              <p className="loan-desc">{item.desc}</p>
              <p className="loan-qty">Qty: {item.qty}</p>
              <p className="loan-id">{item.id}</p>
            </div>
          </div>
        ...
        <div className="account-header-inner">
          <div className="brand-block">
            ...
            <div className="brand-copy">
              ...
              <span className="brand-tagline">Your personal library</span>
            </div>
          </div>
